...
baltimore<- read_tsv("data/arcos-md-baltimore-city-24510-itemized.tsv/arcos-md-baltimore-city-24510-itemized.tsv")
...
#The data has 42 columns and 290,908 rows. The drug codes are in a dbl format and can be in a chr format. The transaction date is in chr format and should be in a date format. Missing values are represented with the word "null."
...
#NewCare Home Health Services in Baltimore received the most pills from 2006 to 2012, with 6.13 million pills. The pharmacy subsequently had its license suspended by the DEA and the state of Maryland. 
...
#Mckesson Corporation is responsible for sending the most pills to Baltimore City, with 58.3 million pills. 
...
#Professional Pharmacy Services in Baltimore had 6,254 shipments. This makes sense because this pharmacy is in a hospital, where people need more medication.
...
#The Rite Aid of Maryland, Inc. had 12.52 percent of the total pills, which was 16.7 million pills out of the 133.7 million that were sent to the entire city.
...
#There are three different Rite Aids. One with a comma, one with a period, and one with T/A at the end.
...
# The shipments leader was SpecGx LLC--RITE AID MID-ATLANTIC--RITE AID OF MARYLAND, INC. with	9087.
# The total pills leader was SpecGx LLC--RITE AID MID-ATLANTIC--RITE AID OF MARYLAND, INC. with	2482900.
# The Avg Pills Per Shipment leader was Actavis Pharma, Inc.--CARDINAL HEALTH--NEWCARE HOME HEALTH SERVICES with 14285.0746
# The Max Pills Per Shipment leader was Actavis Pharma, Inc.--CARDINAL HEALTH--NEWCARE HOME HEALTH SERVICES with 48000
```
